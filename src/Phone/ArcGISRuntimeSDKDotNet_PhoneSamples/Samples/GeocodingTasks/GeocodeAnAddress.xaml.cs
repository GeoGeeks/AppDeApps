...
namespace ArcGISRuntimeSDKDotNet_PhoneSamples.Samples
{
	...
	///
	/// </summary>
	/// <title>Geocodificar Dirección</title>
	...
	public sealed partial class GeocodeAddress : Page
	{
		...
		private async void SetSimpleRendererSymbols()
		{
			...
			{
				var _x = new MessageDialog("Error de selección: " + ex.Message, "Error").ShowAsync();
			}
		}
		...
		private async void GeocodeButton_Click(object sender, RoutedEventArgs e)
		{
			try
			{
				...
				if (candidateResults == null || candidateResults.Count == 0)
					throw new Exception("No se encontraton candidatos.");
