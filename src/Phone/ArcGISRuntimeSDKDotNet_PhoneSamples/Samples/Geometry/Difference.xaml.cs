	...
	public sealed partial class Difference : Page
    {
        ...
        private void AddInputGraphics()
        {
            var g = new Graphic
            {
                ...
                new MapPoint(-75.572189,6.217125),
                new MapPoint(-75.572189,7.217125),
                new MapPoint(-75.072189,7.217125),
                new MapPoint(-75.072189,6.217125)
                /*
            ...
            g = new Graphic
            {
                ...
                new MapPoint(-77.072189,7.217125),
                new MapPoint(-77.072189,8.217125),
                new MapPoint(-75.572189,8.217125),
                new MapPoint(-75.572189,7.217125)
            ...
            {
                Geometry = new Polygon(new List<MapPoint> {
                new MapPoint(-76.372189,7.217125),
                new MapPoint(-75.372189,7.217125),
                new MapPoint(-75.372189,6.717125),
                new MapPoint(-76.372189,6.717125)
