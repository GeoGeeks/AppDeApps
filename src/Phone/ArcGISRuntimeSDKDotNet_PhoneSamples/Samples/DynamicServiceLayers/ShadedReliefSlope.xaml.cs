...
namespace ArcGISRuntimeSDKDotNet_StoreSamples.Samples
{
	...
	/// 
	/// </summary>
    /// <title>Relieve y Pendiente</title>
    /// <category>Sercicios Dinámicos</category>
	public sealed partial class ShadedReliefSlope : Page
    {
        public ShadedReliefSlope()
        {
            this.InitializeComponent();
			mapView1.Map.InitialViewpoint = new Viewpoint(new Envelope(-76.1493, 9.68725, -74.1526, 12.5338, SpatialReferences.Wgs84));
        }
        ...
        private void ShowHideOptions(object sender, RoutedEventArgs e)
        {
            ShadedReliefSlopeOptions.Visibility = (ShadedReliefSlopeOptions.Visibility == Visibility.Visible ? Visibility.Collapsed : Visibility.Visible);
        }
    }
}
