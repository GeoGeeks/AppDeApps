...
namespace ArcGISRuntimeSDKDotNet_StoreSamples.Samples
{
	...
	public sealed partial class RasterFunctions : Page
    {
        ...
        private void ShowHideOptions_Click(object sender, RoutedEventArgs e)
        {
            RasterOptions.Visibility = (RasterOptions.Visibility == Visibility.Visible ? Visibility.Collapsed : Visibility.Visible);
        }
    }
}
