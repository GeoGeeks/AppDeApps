    ...
    internal class SampleDataViewModel : INotifyPropertyChanged
    {
        ...
        public async Task DownloadLocalDataAsync()
        {
            try
            {
				...
				CurrentAction = "Terminó la descarga!";
            }
            catch (Exception ex)
            {
				CurrentAction = "Error en la descarga.";
